...
import {
  ...
  deleteCompetition, deleteChallenge, deleteFantasyGame, setEntryLock, type EntryLockKind,
...
/** Compact entry-lock override editor (popover) for a game row. */
function EntryLockCell({ kind, id, value, onSaved }: { kind: EntryLockKind; id: string; value?: string | null; onSaved: () => void }) {
            ...
            {fComps.map(c => (
              <tr key={c.id} className="border-b border-border-subtle/50">
                ...
                <td className="text-right pr-4 whitespace-nowrap">
                  ...
                  <EntryLockCell kind="tq" id={c.id} value={c.entry_lock_at} onSaved={reload} />
            ...
            {fChallenges.map(c => (
              <tr key={c.id} className="border-b border-border-subtle/50">
                ...
                <td className="text-right pr-4 whitespace-nowrap">
                  ...
                  <EntryLockCell kind="challenge" id={c.id} value={c.entry_lock_at} onSaved={reload} />
            ...
            {fFantasy.map(g => (
              <tr key={g.id} className="border-b border-border-subtle/50">
                ...
                <td className="text-right pr-4 whitespace-nowrap">
                  ...
                  <EntryLockCell kind="fantasy" id={g.id} value={g.entry_lock_at} onSaved={reload} />
