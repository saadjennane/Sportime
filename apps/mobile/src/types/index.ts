...
export type GameType = 'betting' | 'prediction' | 'fantasy' | 'fantasy-live' | 'duel' | 'predictor' | 'f1fantasy';
...
export interface SportimeGame {
  ...
  entry_lock_at?: string;  // ISO date, admin override: explicit entry deadline (supersedes the computed one)
...
export type LiveBetCategory = 'result' | 'goals' | 'scorers' | 'cards' | 'corners' | 'quick' | 'clean_sheet' | 'extra_time' | 'penalties' | 'other';
