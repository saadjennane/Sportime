    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-scale-in">
      <div className="modal-base max-w-sm w-full p-6 space-y-5 relative">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold text-text-primary">Make a Substitution</h2>
          ...
          {availableSubs.length > 0 ? (
            availableSubs.map(sub => (
              <button
                ...
                className="w-full flex items-center gap-3 p-3 bg-deep-navy hover:bg-white/5 rounded-xl transition-colors text-left"
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-text-secondary">{sub.position}</p>
                </div>
                <div className="flex items-center gap-1 text-neon-cyan font-semibold">
                  <Replace size={16} />
                  <span>Sub In</span>
                </div>
              </button>
            ...
            <p className="text-center text-sm text-text-secondary py-4">No available substitutes for this position.</p>
          )}
        </div>
      </div>
    </div>
