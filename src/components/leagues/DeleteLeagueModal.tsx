...
export const DeleteLeagueModal: React.FC<DeleteLeagueModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-scale-in">
      <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full p-6 space-y-5 relative">
        ...
        <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Delete League?</h2>
            <p className="text-sm text-gray-500 mt-1">This action is irreversible. The league and all its member data will be permanently deleted.</p>
        </div>
