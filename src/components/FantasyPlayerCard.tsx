...
export const FantasyPlayerCard: React.FC<FantasyPlayerCardProps> = ({
  player,
  isCaptain,
  onClick,
  isLive,
  ...
  return (
    <div
      className="relative flex flex-col items-center text-center w-20 group"
      onClick={onClick}
    >
      {isCaptain && (
      ...
      <div className="relative w-16 h-16 mb-1">
        <img
          src={player.photo}
          alt={player.name}
          className="w-full h-full rounded-full object-cover bg-gray-200 border-2 border-white shadow-md"
        />
      ...
      <p className="text-xs font-bold text-gray-800 truncate w-full">
        {player.name}
      </p>
