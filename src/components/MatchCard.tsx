...
export const MatchCard: React.FC<MatchCardProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl shadow-lg p-5 transition-all duration-300 ${isUpcoming ? "hover:shadow-xl" : ""}`}
    >
      <div className="flex items-center justify-between mb-4">
        ...
        {isUpcoming ? (
          <span
            className={`text-white text-xs px-3 py-1 rounded-full font-semibold ${betPlaced ? "bg-gradient-to-r from-purple-500 to-indigo-500" : "bg-gradient-to-r from-green-400 to-emerald-500"}`}
          >
