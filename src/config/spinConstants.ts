...
export const SPIN_TIERS: SpinTier[] = ["free", "amateur", "master", "apex", "premium"];
...
export const SPIN_REWARDS: Record<SpinTier, SpinReward[]> = {
  ...
  premium: [
    { id: "masterpass_master", label: "Master MasterPass", baseChance: 0.20, category: 'masterpass' },
    ...
    { id: "ticket_apex_pack", label: "2x Apex Tickets", baseChance: 0.15, category: 'ticket' },
...
export const RARE_REWARD_CATEGORIES: Record<SpinTier, string[]> = {
    ...
    premium: ['gift_card', 'premium', 'masterpass_master'],
};
