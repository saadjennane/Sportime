...
export const mockFantasyPlayers: FantasyPlayer[] = [
  // Goalkeepers
  {
    ...
    avgFantasyScore: 4.5,
    livePoints: 6,
    livePointsBreakdown: { "Clean Sheet": 4, Saves: 2 },
  },
  {
    id: "p12",
    name: "M. ter Stegen",
  ...
  // Defenders
  {
    ...
    avgFantasyScore: 5.1,
    livePoints: 7,
    livePointsBreakdown: { "Clean Sheet": 4, Tackles: 3 },
  },
  {
    id: "p7",
    name: "A. Davies",
    ...
    avgFantasyScore: 5.5,
    livePoints: 2,
    livePointsBreakdown: { Appearance: 2 },
  },
  {
    id: "p9",
    name: "J. Koundé",
    ...
    avgFantasyScore: 4.8,
    livePoints: 1,
    livePointsBreakdown: { "Yellow Card": -1, Appearance: 2 },
  },
  {
    id: "p13",
    name: "R. James",
  ...
  // Midfielders
  {
    id: "p2",
    name: "K. De Bruyne",
    photo: "https://media.api-sports.io/football/players/62.png",
    position: "Midfielder",
    category: "Star",
    fatigue: 88,
    teamName: "Man City",
    ...
    avgFantasyScore: 8.5,
    livePoints: 12,
    livePointsBreakdown: { Assist: 3, "Key Passes": 4, Appearance: 2, Goal: 3 },
  },
  {
    id: "p5",
    name: "J. Bellingham",
    ...
    avgFantasyScore: 9.1,
    livePoints: 3,
    livePointsBreakdown: { "Key Passes": 1, Appearance: 2 },
  },
  {
    id: "p8",
    name: "Pedri",
  ...
  // Attackers
  {
    ...
    teamLogo: "https://media.api-sports.io/football/teams/10101.png",
    birthdate: "1987-06-24",
    pgs: 8.1,
    avgFantasyScore: 10.2,
  },
  {
    id: "p6",
    name: "E. Haaland",
    photo: "https://media.api-sports.io/football/players/969.png",
    position: "Attacker",
    category: "Star",
    fatigue: 90,
    teamName: "Man City",
    ...
    avgFantasyScore: 9.8,
    livePoints: 10,
    livePointsBreakdown: { Goal: 8, Appearance: 2 },
  },
  {
    id: "p11",
    name: "Rafael Leão",
    photo: "https://media.api-sports.io/football/players/241.png",
    position: "Attacker",
    category: "Key",
    fatigue: 85,
    teamName: "AC Milan",
      ...
      conditions: [
        {
          ...
          text: "Max. 2 players from same club",
          value: 2,
        },
        { key: "max_star_players", text: "Max. 2 Star players", value: 2 },
        {
          key: "min_nationality",
          text: "Min. 1 player from Brazil",
          value: "Brazil",
        },
      ],
    },
...
export const mockBoosters: Booster[] = [
  {
    id: 1,
    name: "Double Impact",
    description: "Double your captain's total points.",
  ...
  },
  {
    id: 2,
    name: "Golden Game",
    description: "Get +20% on your entire team's total score.",
  ...
  }, // Mock one as used
  {
    id: 3,
    name: "Recovery Boost",
    description: "Restore one player to 100% fatigue.",
