-- Box2Box: one daily grid (3 rows + 3 cols criteria). Client validates players locally.
CREATE OR REPLACE FUNCTION public.puzzle_get_today_grid()
...
END $$;
GRANT EXECUTE ON FUNCTION public.puzzle_get_today_grid() TO authenticated;
