-- Football Connections: one daily puzzle (4 groups of 4). Client-side play (payload
-- carries the groups/answers). Finish reuses the generic puzzle_finish_player.
CREATE OR REPLACE FUNCTION public.puzzle_get_today_connections()
...
END $$;
GRANT EXECUTE ON FUNCTION public.puzzle_get_today_connections() TO authenticated;
