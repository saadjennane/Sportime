-- ============================================================================
-- Secure join for swipe/prediction challenges.
-- Mirrors join_betting_challenge (eligibility + ticket + server coin deduction)
-- but uses only challenge_participants (no challenge_entries for prediction).
-- ============================================================================
