-- Rapid Fire: one daily question (criterion). Client validates answers vs the grid index.
CREATE OR REPLACE FUNCTION public.puzzle_get_today_rapid()
...
END $$;
GRANT EXECUTE ON FUNCTION public.puzzle_get_today_rapid() TO authenticated;
