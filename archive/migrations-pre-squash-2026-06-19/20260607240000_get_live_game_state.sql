-- ============================================================================
-- Single read for the Live Score Prediction page: game + fixture (with team
-- logos) + all entries (with usernames). SECURITY DEFINER so the page reads
-- reliably regardless of RLS on live_game_entries / profiles.
-- ============================================================================
