 ...
 * Usage: node check_finished_matches.js
 */

const { createClient } = require('@supabase/supabase-js');

// Configuration Supabase (utilise les mêmes variables que l'app)
...
if (!supabaseKey) {
  ...
  console.log('Usage: SUPABASE_ANON_KEY=votre_clé node check_finished_matches.js');
  process.exit(1);
}
